...
const Blog = () => {
  return (
    <>
      <Container>
        <Header></Header>
        <div className="mt-5 w-75 mx-auto min-vh-100">
          ...
          <p className="ms-3 mb-4">
            An uncontrolled component managed by its own state. When user
            interact, uncontrolled component updates its state value. it is more
            difficult to debug and more complex code.
            <br />A controlled component managed by components state. Controlled
            component updates components value on user interaction. It is easy
            to debug, and less complex code than uncontrolled component.
          </p>
          ...
          <p className="ms-3">
            ...
            <br />
            Custom hook can be reused easily, which makes the code cleaner. It
            also enhances the rendering speed. That's why we will create a
            custom hook.
          </p>
        </div>
      </Container>
